...
```javascript
import j1 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-besselj1@v0.3.1-deno/mod.js';
```
...
import besselj1 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-besselj1@v0.3.1-deno/mod.js';
