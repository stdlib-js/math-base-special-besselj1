...
```javascript
import j1 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-besselj1@v0.3.0-deno/mod.js';
```
...
import besselj1 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-besselj1@v0.3.0-deno/mod.js';
